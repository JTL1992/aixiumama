...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView1_riv_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView1_riv_border_width, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView1_riv_border_color);
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mutateBackground = a.getBoolean(R.styleable.RoundedImageView1_riv_mutate_background, false);
        isOval = a.getBoolean(R.styleable.RoundedImageView1_riv_oval, false);

        final int tileMode = a.getInt(R.styleable.RoundedImageView1_riv_tile_mode, TILE_MODE_UNDEFINED);
        if (tileMode != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileMode));
            setTileModeY(parseTileMode(tileMode));
        }

        final int tileModeX = a.getInt(R.styleable.RoundedImageView1_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY = a.getInt(R.styleable.RoundedImageView1_riv_tile_mode_y, TILE_MODE_UNDEFINED);
